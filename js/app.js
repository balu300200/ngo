        ...
        if (myCursor.length) {
            if ($("body")) {
                ...
                let n,
                    i = 0,
                    o = !1,
                    speedSmall = 0.1,  // Speed for small ball (faster)
                    speedLarge = 0.05; // Speed for large ball (slower)
                
                let lastXSmall = 0, lastYSmall = 0; // To store the last position of the small cursor
                let lastXLarge = 0, lastYLarge = 0; // To store the last position of the large cursor
                let cursorX = 0, cursorY = 0; // To store the current position of the cursor
                ...
                function updateCursorPosition() {
                    // Move the small cursor first (faster)
                    lastXSmall += (cursorX - lastXSmall) * speedSmall;
                    lastYSmall += (cursorY - lastYSmall) * speedSmall;
    
                    // Move the large cursor after (slower)
                    lastXLarge += (cursorX - lastXLarge) * speedLarge;
                    lastYLarge += (cursorY - lastYLarge) * speedLarge;
    
                    // Apply the position of the cursors to both elements
                    t.style.transform = "translate(" + lastXLarge + "px, " + lastYLarge + "px)"; // Large ball
                    e.style.transform = "translate(" + lastXSmall + "px, " + lastYSmall + "px)";  // Small ball
    
                    // Call updateCursorPosition again for the next frame
